...
//Lấy về danh sách liên hệ sắp xếp theo tăng dần------------------------------
route.get('/get-asc', function(req, res){
    var sql = "CALL sp_lienhe_getall_asc()";
...
//Lấy về danh sách liên hệ sắp xếp theo giảm dần------------------------------
route.get('/get-desc', function(req, res){
    var sql = "CALL sp_lienhe_getall_desc()";
...
route.get('/get-by-id/:id', function(req, res){
    ...
    var sql = "CALL sp_lienhe_getbyid(?)";
